...
var ContentFlowGlobal = {
    ...
    init: function () {
        ...
        this.addStylesheet("/site/css/style.contentflow.css");
        ...
        if (this.Browser.IE) {
            ...
            if (CFobj._reflectionColorRGB) {
                ...
                // color gradient
                    ...
                    var _background = jQuery("html , body").css("background-color");

                    reflection.style.backgroundColor = _background;
                    reflection.appendChild(RefImg);
                }
                filterString += ' progid:DXImageTransform.Microsoft.Alpha(opacity=0, finishOpacity=30, style=1, finishX=0, startY='+CFobj.conf.reflectionHeight*100+' finishY=0)';
            } else {
                var RefImg = reflection = this.reflection = document.createElement('img');
                reflection.src = image.src;
            }
