       ...
       <td>
        <div class="comments" style=" margin-left: {math equation='x*16' x=$node.level}px;" >
            <a href ="{$root_url}{$ctrlName}/modify_comment/id/{$node.id}">
                <img src="{$BASE_URL}cms/img/icons/edit.png" alt="Редактировать" align="left">
            </a>
            <a href ="{$root_url}{$ctrlName}/delete_comment/id/{$node.id}">
                <img src="{$BASE_URL}cms/img/icons/delete.png" alt="Удалить комментарий" align="left">
            </a>
            <a href ="{$root_url}{$ctrlName}/delete_all_comments/id/{$node.id}">
                <img src="{$BASE_URL}cms/img/icons/delete!.png" alt="Удалить этот и все комментарии к нему" align="left">
