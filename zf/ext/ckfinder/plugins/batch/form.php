<div style=\"padding: 20px \"> 
	...
	<form action=<?= PUBLIC_PATH.'zf/ckfinder/core/connector/php/connector.php?command=FileUpload&type='.$_GET['type'] ?>&currentFolder=<?=$_GET['currentFolder'] ?>' method='post' enctype='multipart/form-data'>
